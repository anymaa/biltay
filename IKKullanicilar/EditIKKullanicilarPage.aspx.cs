...
// This file implements the code-behind class for EditIKKullanicilarPage.aspx.
// App_Code\EditIKKullanicilarPage.Controls.vb contains the Table, Row and Record control classes
...
partial class EditIKKullanicilarPage
        : BaseApplicationPage
// Code-behind class for the EditIKKullanicilarPage page.
...
#region "Section 2: Do not modify this section."
      ...
      // their parent ids from their parent UI controls.
                    ...
                    this.IKKullanicilarRecordControl.LoadData();
          
                    this.HaberlerTableControl.LoadData();
          
                    this.HaberlerTableControl1.LoadData();
        ...
        public void SaveButton_Click_Base(object sender, EventArgs args)
        {
            ...
            try {
                ...
                if (!this.IsPageRefresh) {
                    ...
                    this.IKKullanicilarRecordControl.SaveData();
              
                }
        
                if (!this.IsPageRefresh) {
            
                    this.HaberlerTableControl.SaveData();
              
                }
        
                if (!this.IsPageRefresh) {
            
                    this.HaberlerTableControl1.SaveData();
            ...
            if(TargetKey != null){
				...
				if (this.IKKullanicilarRecordControl != null && this.IKKullanicilarRecordControl.DataSource != null){
					id = this.IKKullanicilarRecordControl.DataSource.KullaniciID.ToString();
					value = this.IKKullanicilarRecordControl.DataSource.GetValue(this.IKKullanicilarRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString();
					if(value == null){
					  value = id;
					}
