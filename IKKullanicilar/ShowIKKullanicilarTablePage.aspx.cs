...
// This file implements the code-behind class for ShowIKKullanicilarTablePage.aspx.
// App_Code\ShowIKKullanicilarTablePage.Controls.vb contains the Table, Row and Record control classes
...
partial class ShowIKKullanicilarTablePage
        : BaseApplicationPage
// Code-behind class for the ShowIKKullanicilarTablePage page.
...
#region "Section 1: Place your customizations here."    
        ...
        public ShowIKKullanicilarTablePage()
      {
      this.Initialize();
      }
...
#region "Ajax Functions"
        ...
        [System.Web.Services.WebMethod]
        public static string[] GetAutoCompletionList_IKKullanicilarSearchArea(String prefixText, int count)
        {
            // GetIKKullanicilarSearchAreaCompletionList gets the list of suggestions from the database.
            // prefixText is the search text typed by the user .
            // count specifies the number of suggestions to be returned.
            // Customize by adding code before or after the call to  GetAutoCompletionList_IKKullanicilarSearchArea_Base()
            // or replace the call to GetAutoCompletionList_IKKullanicilarSearchArea_Base().
            return GetAutoCompletionList_IKKullanicilarSearchArea_Base(prefixText, count);
        }
...
#region "Section 2: Do not modify this section."
      ...
      // their parent ids from their parent UI controls.
                    ...
                    this.IKKullanicilarTableControl.LoadData();
    ...
    public static string[] GetAutoCompletionList_IKKullanicilarSearchArea_Base(String prefixText, int count)
    {
        ...
        KumePortali.UI.Controls.ShowIKKullanicilarTablePage.IKKullanicilarTableControl control = new KumePortali.UI.Controls.ShowIKKullanicilarTablePage.IKKullanicilarTableControl();
        
        return control.GetAutoCompletionList_IKKullanicilarSearchArea(prefixText, count);
