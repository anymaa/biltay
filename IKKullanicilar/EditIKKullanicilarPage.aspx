...
<%@ Register Tagprefix="KumePortali" Namespace="KumePortali.UI.Controls.EditIKKullanicilarPage" %>

<%@ Register Tagprefix="KumePortali" TagName="Pagination" Src="../Shared/Pagination.ascx" %>

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="EditIKKullanicilarPage.aspx.cs" Culture="tr-TR" Inherits="KumePortali.UI.EditIKKullanicilarPage" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <title><asp:Literal runat="server" id="PageTitle" Text="&lt;%#String.Concat(GetResourceValue(&quot;Title:Edit&quot;, &quot;KumePortali&quot;),&quot; IK Kullanicilar&quot;) %>">
</asp:Literal></title>
...
<!-- Begin Record Panel.html -->
 ...
 <%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControl("EditButton$_Button")) %>
    ...
    <tr>
    <td class="dhtr" valign="middle"><asp:Literal runat="server" id="IKKullanicilarTitle" Text="Edit IK Kullanicilar">
														</asp:Literal></td>
    </tr>
    </table>
    </td>
