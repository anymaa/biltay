...
/// <see cref="SliderTable">KumePortali.SliderTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="SliderTable"></seealso>
public class SliderDefinition
{
#region "Definition (XML) for SliderDefinition table"
	//Next 318 lines contain Table Definition (XML) for table "SliderDefinition"
	private static string _DefinitionString = 
@"<XMLDefinition Generator=""Iron Speed Designer"" Version=""5.2"" Type=""GENERIC"">" +
  @"<ColumnDefinition>" +
    @"<Column InternalName=""0"" Priority=""1"" ColumnNum=""0"">" +
      @"<columnName>SliderResimID</columnName>" +
      @"<columnUIName>Slider Resim ID</columnUIName>" +
    ...
    @"<Column InternalName=""2"" Priority=""3"" ColumnNum=""2"">" +
      ...
      @"<columnUIName>URL</columnUIName>" +
      @"<columnType>Web Url</columnType>" +
    ...
    @"<Column InternalName=""3"" Priority=""4"" ColumnNum=""3"">" +
      @"<columnName>Baslik</columnName>" +
      @"<columnUIName>Baslik</columnUIName>" +
    ...
    @"<Column InternalName=""4"" Priority=""5"" ColumnNum=""4"">" +
      @"<columnName>BaslikEn</columnName>" +
      @"<columnUIName>Baslik En</columnUIName>" +
      @"<columnType>String</columnType>" +
      @"<columnDBType>nvarchar</columnDBType>" +
      @"<columnLengthSet>30</columnLengthSet>" +
      @"<columnDefault></columnDefault>" +
    ...
    @"<Column InternalName=""8"" Priority=""9"" ColumnNum=""8"">" +
      @"<columnName>Sira</columnName>" +
      @"<columnUIName>Sira</columnUIName>" +
      @"<columnType>Number</columnType>" +
    ...
    @"<Column InternalName=""10"" Priority=""11"" ColumnNum=""10"">" +
      ...
      @"<columnTableAliasName></columnTableAliasName>" +
      @"<foreignKey>" +
        @"<columnFKName>FK_Slider_IKKullanicilar</columnFKName>" +
    ...
    @"<Column InternalName=""12"" Priority=""13"" ColumnNum=""12"">" +
      ...
      @"<columnTableAliasName></columnTableAliasName>" +
      @"<foreignKey>" +
        @"<columnFKName>FK_Slider_IKKullanicilar1</columnFKName>" +
        @"<columnFKTable>KumePortali.Business.IKKullanicilarTable, App_Code</columnFKTable>" +
        @"<columnFKOwner>SistemAyarlari</columnFKOwner>" +
        @"<columnFKColumn>KullaniciID</columnFKColumn>" +
        @"<columnFKColumnDisplay>Adi</columnFKColumnDisplay>" +
  ...
  @"<TableCodeName>Slider</TableCodeName>" +
  @"<TableAliasName>Slider_</TableAliasName>" +
