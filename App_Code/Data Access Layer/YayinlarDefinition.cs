...
/// <see cref="YayinlarTable">KumePortali.YayinlarTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="YayinlarTable"></seealso>
public class YayinlarDefinition
{
#region "Definition (XML) for YayinlarDefinition table"
	//Next 318 lines contain Table Definition (XML) for table "YayinlarDefinition"
	private static string _DefinitionString = 
@"<XMLDefinition Generator=""Iron Speed Designer"" Version=""5.2"" Type=""GENERIC"">" +
  @"<ColumnDefinition>" +
    @"<Column InternalName=""0"" Priority=""1"" ColumnNum=""0"">" +
      @"<columnName>YayinID</columnName>" +
      @"<columnUIName>Yayin ID</columnUIName>" +
    ...
    @"<Column InternalName=""5"" Priority=""6"" ColumnNum=""5"">" +
      ...
      @"<columnType>String</columnType>" +
      @"<columnDBType>nvarchar</columnDBType>" +
      @"<columnLengthSet>500</columnLengthSet>" +
      @"<columnDefault></columnDefault>" +
      @"<columnDBDefault></columnDBDefault>" +
      @"<columnIndex>N</columnIndex>" +
      @"<columnUnique>N</columnUnique>" +
    ...
    @"<Column InternalName=""8"" Priority=""9"" ColumnNum=""8"">" +
      @"<columnName>EkleyenID</columnName>" +
      @"<columnUIName>Ekleyen ID</columnUIName>" +
      @"<columnType>Number</columnType>" +
      @"<columnDBType>int</columnDBType>" +
      @"<columnLengthSet>10.0</columnLengthSet>" +
      @"<columnDefault></columnDefault>" +
      ...
      @"<columnTableAliasName></columnTableAliasName>" +
      @"<foreignKey>" +
        @"<columnFKName>FK_Yayinlar_EkleyenKullanici</columnFKName>" +
    ...
    @"<Column InternalName=""10"" Priority=""11"" ColumnNum=""10"">" +
      @"<columnName>EklenmeTarihi</columnName>" +
      @"<columnUIName>Eklenme Tarihi</columnUIName>" +
    ...
    @"<Column InternalName=""11"" Priority=""12"" ColumnNum=""11"">" +
      @"<columnName>DuzenlenyenID</columnName>" +
      @"<columnUIName>Duzenlenyen ID</columnUIName>" +
      @"<columnType>Number</columnType>" +
      @"<columnDBType>int</columnDBType>" +
      @"<columnLengthSet>10.0</columnLengthSet>" +
      @"<columnDefault></columnDefault>" +
      ...
      @"<columnTableAliasName></columnTableAliasName>" +
      @"<foreignKey>" +
        @"<columnFKName>FK_Yayinlar_DuzenleyenKullanici</columnFKName>" +
        @"<columnFKTable>KumePortali.Business.IKKullanicilarTable, App_Code</columnFKTable>" +
        @"<columnFKOwner>SistemAyarlari</columnFKOwner>" +
        @"<columnFKColumn>KullaniciID</columnFKColumn>" +
        @"<columnFKColumnDisplay>Adi</columnFKColumnDisplay>" +
    ...
    "</Column>" +
  "</ColumnDefinition>" +
  @"<TableName>Yayinlar</TableName>" +
  @"<Version></Version>" +
  @"<Owner>IcHaberlesme</Owner>" +
  @"<TableCodeName>Yayinlar</TableCodeName>" +
  @"<TableAliasName>Yayinlar_</TableAliasName>" +
