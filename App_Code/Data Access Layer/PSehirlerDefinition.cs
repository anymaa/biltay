...
/// <see cref="PSehirlerTable">KumePortali.PSehirlerTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="PSehirlerTable"></seealso>
public class PSehirlerDefinition
{
#region "Definition (XML) for PSehirlerDefinition table"
	//Next 126 lines contain Table Definition (XML) for table "PSehirlerDefinition"
...
@"<XMLDefinition Generator=""Iron Speed Designer"" Version=""5.2"" Type=""GENERIC"">" +
  @"<ColumnDefinition>" +
    ...
    @"<Column InternalName=""1"" Priority=""2"" ColumnNum=""1"">" +
      @"<columnName>IlTrefikKodu</columnName>" +
      @"<columnUIName>Il Trefik Kodu</columnUIName>" +
      @"<columnType>Number</columnType>" +
      @"<columnDBType>int</columnDBType>" +
      @"<columnLengthSet>10.0</columnLengthSet>" +
      @"<columnDefault></columnDefault>" +
    ...
    @"<Column InternalName=""2"" Priority=""3"" ColumnNum=""2"">" +
      @"<columnName>SehirAdi</columnName>" +
      @"<columnUIName>Sehir Adi</columnUIName>" +
    ...
    @"<Column InternalName=""3"" Priority=""4"" ColumnNum=""3"">" +
      ...
      @"<columnType>String</columnType>" +
      @"<columnDBType>char</columnDBType>" +
    ...
    "</Column>" +
  "</ColumnDefinition>" +
  @"<TableName>PSehirler</TableName>" +
  @"<Version></Version>" +
  @"<Owner>SistemAyarlari</Owner>" +
  @"<TableCodeName>PSehirler</TableCodeName>" +
  @"<TableAliasName>PSehirler_</TableAliasName>" +
