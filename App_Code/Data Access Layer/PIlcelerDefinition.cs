...
/// <see cref="PIlcelerTable">KumePortali.PIlcelerTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="PIlcelerTable"></seealso>
public class PIlcelerDefinition
{
#region "Definition (XML) for PIlcelerDefinition table"
	//Next 82 lines contain Table Definition (XML) for table "PIlcelerDefinition"
...
@"<XMLDefinition Generator=""Iron Speed Designer"" Version=""5.2"" Type=""GENERIC"">" +
  @"<ColumnDefinition>" +
    ...
    "</Column>" +
  "</ColumnDefinition>" +
  @"<TableName>PIlceler</TableName>" +
  @"<Version></Version>" +
  @"<Owner>SistemAyarlari</Owner>" +
  @"<TableCodeName>PIlceler</TableCodeName>" +
  @"<TableAliasName>PIlceler_</TableAliasName>" +
