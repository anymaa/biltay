...
/// <see cref="IsBasvurulariTable">KumePortali.IsBasvurulariTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="IsBasvurulariTable"></seealso>
public class IsBasvurulariDefinition
{
#region "Definition (XML) for IsBasvurulariDefinition table"
	//Next 186 lines contain Table Definition (XML) for table "IsBasvurulariDefinition"
	private static string _DefinitionString = 
@"<XMLDefinition Generator=""Iron Speed Designer"" Version=""5.2"" Type=""GENERIC"">" +
  @"<ColumnDefinition>" +
    @"<Column InternalName=""0"" Priority=""1"" ColumnNum=""0"">" +
      @"<columnName>IsBasvuruID</columnName>" +
      @"<columnUIName>Is Basvuru ID</columnUIName>" +
    ...
    @"<Column InternalName=""1"" Priority=""2"" ColumnNum=""1"">" +
      ...
      @"<columnTableAliasName></columnTableAliasName>" +
      @"<foreignKey>" +
        @"<columnFKName>FK_IsBasvurulari_AcikIlanlar</columnFKName>" +
        @"<columnFKTable>KumePortali.Business.AcikIlanlarTable, App_Code</columnFKTable>" +
        @"<columnFKOwner>InsanKaynaklari</columnFKOwner>" +
        @"<columnFKColumn>IlanID</columnFKColumn>" +
        @"<columnFKColumnDisplay>IlanNo</columnFKColumnDisplay>" +
        @"<foreignKeyType>Explicit</foreignKeyType>" +
      "</foreignKey>" +
    "</Column>" +
    @"<Column InternalName=""2"" Priority=""3"" ColumnNum=""2"">" +
      @"<columnName>AdayID</columnName>" +
      @"<columnUIName>Aday ID</columnUIName>" +
      @"<columnType>Number</columnType>" +
      @"<columnDBType>int</columnDBType>" +
      @"<columnLengthSet>10.0</columnLengthSet>" +
      @"<columnDefault></columnDefault>" +
      ...
      @"<columnTableAliasName></columnTableAliasName>" +
      @"<foreignKey>" +
        @"<columnFKName>FK_IsBasvurulari_IKKullanicilar</columnFKName>" +
    ...
    @"<Column InternalName=""3"" Priority=""4"" ColumnNum=""3"">" +
      @"<columnName>BasvuruTarihi</columnName>" +
      @"<columnUIName>Basvuru Tarihi</columnUIName>" +
    ...
    @"<Column InternalName=""4"" Priority=""5"" ColumnNum=""4"">" +
      @"<columnName>BasvuruDegerlendirme</columnName>" +
      @"<columnUIName>Basvuru Degerlendirme</columnUIName>" +
    ...
    @"<Column InternalName=""5"" Priority=""6"" ColumnNum=""5"">" +
      @"<columnName>DegerlendirmeTarihi</columnName>" +
      @"<columnUIName>Degerlendirme Tarihi</columnUIName>" +
      @"<columnType>Date</columnType>" +
      @"<columnDBType>smalldatetime</columnDBType>" +
      @"<columnLengthSet></columnLengthSet>" +
      @"<columnDefault></columnDefault>" +
    ...
    @"<Column InternalName=""6"" Priority=""7"" ColumnNum=""6"">" +
      @"<columnName>DegerlendirmeNotu</columnName>" +
      @"<columnUIName>Degerlendirme Notu</columnUIName>" +
      @"<columnType>String</columnType>" +
      @"<columnDBType>nvarchar</columnDBType>" +
    ...
    "</Column>" +
  "</ColumnDefinition>" +
  @"<TableName>IsBasvurulari</TableName>" +
  @"<Version></Version>" +
  @"<Owner>InsanKaynaklari</Owner>" +
  @"<TableCodeName>IsBasvurulari</TableCodeName>" +
  @"<TableAliasName>IsBasvurulari_</TableAliasName>" +
...
"</XMLDefinition>";
	...
	/// <see cref="IsBasvurulariTable"></see>
