...
/// <see cref="PYKategorilerTable">KumePortali.PYKategorilerTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="PYKategorilerTable"></seealso>
public class PYKategorilerDefinition
{
#region "Definition (XML) for PYKategorilerDefinition table"
	//Next 170 lines contain Table Definition (XML) for table "PYKategorilerDefinition"
...
@"<XMLDefinition Generator=""Iron Speed Designer"" Version=""5.2"" Type=""GENERIC"">" +
  @"<ColumnDefinition>" +
    ...
    @"<Column InternalName=""2"" Priority=""3"" ColumnNum=""2"">" +
      @"<columnName>KategoriAdiEN</columnName>" +
      @"<columnUIName>Kategori Adi EN</columnUIName>" +
      @"<columnType>String</columnType>" +
      @"<columnDBType>nvarchar</columnDBType>" +
      @"<columnLengthSet>150</columnLengthSet>" +
      @"<columnDefault></columnDefault>" +
    ...
    "</Column>" +
  "</ColumnDefinition>" +
  @"<TableName>PYKategoriler</TableName>" +
  @"<Version></Version>" +
  @"<Owner>ProjeYonetimi</Owner>" +
  @"<TableCodeName>PYKategoriler</TableCodeName>" +
  @"<TableAliasName>PYKategoriler_</TableAliasName>" +
...
"</XMLDefinition>";
	...
	/// <see cref="PYKategorilerTable"></see>
