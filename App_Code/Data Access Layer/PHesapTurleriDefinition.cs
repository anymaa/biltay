...
/// <see cref="PHesapTurleriTable">KumePortali.PHesapTurleriTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="PHesapTurleriTable"></seealso>
public class PHesapTurleriDefinition
{
#region "Definition (XML) for PHesapTurleriDefinition table"
	//Next 82 lines contain Table Definition (XML) for table "PHesapTurleriDefinition"
...
@"<XMLDefinition Generator=""Iron Speed Designer"" Version=""5.2"" Type=""GENERIC"">" +
  @"<ColumnDefinition>" +
    ...
    @"<Column InternalName=""1"" Priority=""2"" ColumnNum=""1"">" +
      @"<columnName>HesapTuru</columnName>" +
      @"<columnUIName>Hesap Turu</columnUIName>" +
      @"<columnType>String</columnType>" +
      @"<columnDBType>nvarchar</columnDBType>" +
    ...
    "</Column>" +
  "</ColumnDefinition>" +
  @"<TableName>PHesapTurleri</TableName>" +
  @"<Version></Version>" +
  @"<Owner>SistemAyarlari</Owner>" +
  @"<TableCodeName>PHesapTurleri</TableCodeName>" +
  @"<TableAliasName>PHesapTurleri_</TableAliasName>" +
...
"</XMLDefinition>";
	...
	/// <see cref="PHesapTurleriTable"></see>
