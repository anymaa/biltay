...
/// <see cref="PFirmaKategoriTable">KumePortali.PFirmaKategoriTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="PFirmaKategoriTable"></seealso>
public class PFirmaKategoriDefinition
{
#region "Definition (XML) for PFirmaKategoriDefinition table"
	//Next 98 lines contain Table Definition (XML) for table "PFirmaKategoriDefinition"
	private static string _DefinitionString = 
@"<XMLDefinition Generator=""Iron Speed Designer"" Version=""5.2"" Type=""GENERIC"">" +
  @"<ColumnDefinition>" +
    @"<Column InternalName=""0"" Priority=""1"" ColumnNum=""0"">" +
      @"<columnName>FirmaKategoriID</columnName>" +
      @"<columnUIName>Firma Kategori ID</columnUIName>" +
    ...
    @"<Column InternalName=""1"" Priority=""2"" ColumnNum=""1"">" +
      ...
      @"<columnTableAliasName></columnTableAliasName>" +
      @"<foreignKey>" +
        @"<columnFKName>FK_PFirmaKategori_PKategoriler</columnFKName>" +
        @"<columnFKTable>KumePortali.Business.PKategorilerTable, App_Code</columnFKTable>" +
    ...
    @"<Column InternalName=""2"" Priority=""3"" ColumnNum=""2"">" +
      ...
      @"<columnTableAliasName></columnTableAliasName>" +
      @"<foreignKey>" +
        @"<columnFKName>FK_PFirmaKategori_MIYSAHesaplar</columnFKName>" +
    ...
    "</Column>" +
  "</ColumnDefinition>" +
  @"<TableName>PFirmaKategori</TableName>" +
  @"<Version></Version>" +
  @"<Owner>SistemAyarlari</Owner>" +
  @"<TableCodeName>PFirmaKategori</TableCodeName>" +
  @"<TableAliasName>PFirmaKategori_</TableAliasName>" +
...
"</XMLDefinition>";
	...
	/// <see cref="PFirmaKategoriTable"></see>
