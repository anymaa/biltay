...
/// <see cref="TedarikciDegerlendirmeTable">KumePortali.TedarikciDegerlendirmeTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="TedarikciDegerlendirmeTable"></seealso>
public class TedarikciDegerlendirmeDefinition
{
#region "Definition (XML) for TedarikciDegerlendirmeDefinition table"
	//Next 370 lines contain Table Definition (XML) for table "TedarikciDegerlendirmeDefinition"
	private static string _DefinitionString = 
@"<XMLDefinition Generator=""Iron Speed Designer"" Version=""5.2"" Type=""GENERIC"">" +
  @"<ColumnDefinition>" +
    @"<Column InternalName=""0"" Priority=""1"" ColumnNum=""0"">" +
      @"<columnName>DegerlendirmeID</columnName>" +
      @"<columnUIName>Degerlendirme ID</columnUIName>" +
    ...
    @"<Column InternalName=""1"" Priority=""2"" ColumnNum=""1"">" +
      ...
      @"<columnTableAliasName></columnTableAliasName>" +
      @"<foreignKey>" +
        @"<columnFKName>FK_TedarikciDegerlendirme_Ihale</columnFKName>" +
    ...
    @"<Column InternalName=""2"" Priority=""3"" ColumnNum=""2"">" +
      ...
      @"<columnTableAliasName></columnTableAliasName>" +
      @"<foreignKey>" +
        @"<columnFKName>FK_TedarikciDegerlendirme_IhaleTeklif</columnFKName>" +
        @"<columnFKTable>KumePortali.Business.IhaleTeklifTable, App_Code</columnFKTable>" +
        @"<columnFKOwner>ESatinAlma</columnFKOwner>" +
        @"<columnFKColumn>IhaleTeklifID</columnFKColumn>" +
        @"<columnFKColumnDisplay>Aciklama</columnFKColumnDisplay>" +
        @"<foreignKeyType>Explicit</foreignKeyType>" +
      "</foreignKey>" +
    "</Column>" +
    @"<Column InternalName=""3"" Priority=""4"" ColumnNum=""3"">" +
      ...
      @"<columnTableAliasName></columnTableAliasName>" +
      @"<foreignKey>" +
        @"<columnFKName>FK_TedarikciDegerlendirme_MIYSAHesaplar</columnFKName>" +
    ...
    @"<Column InternalName=""4"" Priority=""5"" ColumnNum=""4"">" +
      @"<columnName>TeslimTarihi</columnName>" +
      @"<columnUIName>Teslim Tarihi</columnUIName>" +
    ...
    @"<Column InternalName=""5"" Priority=""6"" ColumnNum=""5"">" +
      @"<columnName>Gonderilen</columnName>" +
      @"<columnUIName>Gonderilen</columnUIName>" +
      @"<columnType>Number</columnType>" +
      @"<columnDBType>int</columnDBType>" +
      @"<columnLengthSet>10.0</columnLengthSet>" +
      @"<columnDefault></columnDefault>" +
    ...
    @"<Column InternalName=""6"" Priority=""7"" ColumnNum=""6"">" +
      @"<columnName>Fire</columnName>" +
      @"<columnUIName>Fire</columnUIName>" +
      @"<columnType>Number</columnType>" +
      @"<columnDBType>int</columnDBType>" +
      @"<columnLengthSet>10.0</columnLengthSet>" +
      @"<columnDefault></columnDefault>" +
    ...
    @"<Column InternalName=""7"" Priority=""8"" ColumnNum=""7"">" +
      @"<columnName>SorunlaraCozum</columnName>" +
      @"<columnUIName>Sorunlara Cozum</columnUIName>" +
      @"<columnType>Number</columnType>" +
    ...
    @"<Column InternalName=""8"" Priority=""9"" ColumnNum=""8"">" +
      @"<columnName>TeknikYeterlilik</columnName>" +
      @"<columnUIName>Teknik Yeterlilik</columnUIName>" +
      @"<columnType>Number</columnType>" +
      @"<columnDBType>tinyint</columnDBType>" +
      @"<columnLengthSet>3.0</columnLengthSet>" +
      @"<columnDefault></columnDefault>" +
    ...
    @"<Column InternalName=""9"" Priority=""10"" ColumnNum=""9"">" +
      @"<columnName>TalepleriKarsilayabilme</columnName>" +
      @"<columnUIName>Talepleri Karsilayabilme</columnUIName>" +
      @"<columnType>Number</columnType>" +
      @"<columnDBType>tinyint</columnDBType>" +
      @"<columnLengthSet>3.0</columnLengthSet>" +
      @"<columnDefault></columnDefault>" +
    ...
    @"<Column InternalName=""10"" Priority=""11"" ColumnNum=""10"">" +
      @"<columnName>KaliteProsesleri</columnName>" +
      @"<columnUIName>Kalite Prosesleri</columnUIName>" +
      @"<columnType>Number</columnType>" +
      @"<columnDBType>tinyint</columnDBType>" +
      @"<columnLengthSet>3.0</columnLengthSet>" +
      @"<columnDefault></columnDefault>" +
    ...
    "</Column>" +
  "</ColumnDefinition>" +
  @"<TableName>TedarikciDegerlendirme</TableName>" +
  @"<Version></Version>" +
  @"<Owner>ESatinAlma</Owner>" +
  @"<TableCodeName>TedarikciDegerlendirme</TableCodeName>" +
  @"<TableAliasName>TedarikciDegerlendirme_</TableAliasName>" +
...
"</XMLDefinition>";
	...
	/// <see cref="TedarikciDegerlendirmeTable"></see>
