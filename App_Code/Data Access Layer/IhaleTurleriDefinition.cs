...
/// <see cref="IhaleTurleriTable">KumePortali.IhaleTurleriTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="IhaleTurleriTable"></seealso>
public class IhaleTurleriDefinition
{
#region "Definition (XML) for IhaleTurleriDefinition table"
	//Next 208 lines contain Table Definition (XML) for table "IhaleTurleriDefinition"
...
@"<XMLDefinition Generator=""Iron Speed Designer"" Version=""5.2"" Type=""GENERIC"">" +
  @"<ColumnDefinition>" +
    ...
    @"<Column InternalName=""1"" Priority=""2"" ColumnNum=""1"">" +
      @"<columnName>IhaleTurAdi</columnName>" +
      @"<columnUIName>Ihale Tur Adi</columnUIName>" +
    ...
    @"<Column InternalName=""2"" Priority=""3"" ColumnNum=""2"">" +
      @"<columnName>IhaleTurAdiEN</columnName>" +
      @"<columnUIName>Ihale Tur Adi EN</columnUIName>" +
      @"<columnType>String</columnType>" +
      @"<columnDBType>nvarchar</columnDBType>" +
      @"<columnLengthSet>25</columnLengthSet>" +
      @"<columnDefault></columnDefault>" +
    ...
    @"<Column InternalName=""4"" Priority=""5"" ColumnNum=""4"">" +
      ...
      @"<columnTableAliasName></columnTableAliasName>" +
      @"<foreignKey>" +
        @"<columnFKName>FK_IhaleTurleri_IKKullanicilar</columnFKName>" +
    ...
    @"<Column InternalName=""6"" Priority=""7"" ColumnNum=""6"">" +
      ...
      @"<columnTableAliasName></columnTableAliasName>" +
      @"<foreignKey>" +
        @"<columnFKName>FK_IhaleTurleri_IKKullanicilar1</columnFKName>" +
        @"<columnFKTable>KumePortali.Business.IKKullanicilarTable, App_Code</columnFKTable>" +
        @"<columnFKOwner>SistemAyarlari</columnFKOwner>" +
        @"<columnFKColumn>KullaniciID</columnFKColumn>" +
        @"<columnFKColumnDisplay>Adi</columnFKColumnDisplay>" +
    ...
    "</Column>" +
  "</ColumnDefinition>" +
  @"<TableName>IhaleTurleri</TableName>" +
  @"<Version></Version>" +
  @"<Owner>ESatinAlma</Owner>" +
  @"<TableCodeName>IhaleTurleri</TableCodeName>" +
  @"<TableAliasName>IhaleTurleri_</TableAliasName>" +
...
"</XMLDefinition>";
	...
	/// <see cref="IhaleTurleriTable"></see>
