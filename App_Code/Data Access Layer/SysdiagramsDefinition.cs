...
/// <see cref="SysdiagramsTable">KumePortali.SysdiagramsTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="SysdiagramsTable"></seealso>
public class SysdiagramsDefinition
{
#region "Definition (XML) for SysdiagramsDefinition table"
	//Next 126 lines contain Table Definition (XML) for table "SysdiagramsDefinition"
...
@"<XMLDefinition Generator=""Iron Speed Designer"" Version=""5.2"" Type=""GENERIC"">" +
  @"<ColumnDefinition>" +
    @"<Column InternalName=""0"" Priority=""1"" ColumnNum=""0"">" +
      ...
      @"<columnLengthSet>128</columnLengthSet>" +
    ...
    @"<Column InternalName=""1"" Priority=""2"" ColumnNum=""1"">" +
      @"<columnName>principal_id</columnName>" +
      @"<columnUIName>Principal ID</columnUIName>" +
    ...
    @"<Column InternalName=""2"" Priority=""3"" ColumnNum=""2"">" +
      @"<columnName>diagram_id</columnName>" +
      @"<columnUIName>Diagram ID</columnUIName>" +
      @"<columnType>Number</columnType>" +
      @"<columnDBType>int</columnDBType>" +
      @"<columnLengthSet>10.0</columnLengthSet>" +
      @"<columnDefault></columnDefault>" +
    ...
    @"<Column InternalName=""3"" Priority=""4"" ColumnNum=""3"">" +
      ...
      @"<columnUIName>Version</columnUIName>" +
      @"<columnType>Number</columnType>" +
      @"<columnDBType>int</columnDBType>" +
      @"<columnLengthSet>10.0</columnLengthSet>" +
      @"<columnDefault></columnDefault>" +
    ...
    @"<Column InternalName=""4"" Priority=""5"" ColumnNum=""4"">" +
      ...
      @"<columnUIName>Definition</columnUIName>" +
    ...
    "</Column>" +
  "</ColumnDefinition>" +
  @"<TableName>sysdiagrams</TableName>" +
  @"<Version></Version>" +
  @"<Owner>dbo</Owner>" +
  @"<TableCodeName>Sysdiagrams</TableCodeName>" +
  @"<TableAliasName>Sysdiagrams_</TableAliasName>" +
