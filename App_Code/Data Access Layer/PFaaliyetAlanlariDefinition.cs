...
/// <see cref="PFaaliyetAlanlariTable">KumePortali.PFaaliyetAlanlariTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="PFaaliyetAlanlariTable"></seealso>
public class PFaaliyetAlanlariDefinition
{
#region "Definition (XML) for PFaaliyetAlanlariDefinition table"
	//Next 82 lines contain Table Definition (XML) for table "PFaaliyetAlanlariDefinition"
...
@"<XMLDefinition Generator=""Iron Speed Designer"" Version=""5.2"" Type=""GENERIC"">" +
  @"<ColumnDefinition>" +
    ...
    @"<Column InternalName=""1"" Priority=""2"" ColumnNum=""1"">" +
      @"<columnName>FaaliyetAlanAdi</columnName>" +
      @"<columnUIName>Faaliyet Alan Adi</columnUIName>" +
    ...
    "</Column>" +
  "</ColumnDefinition>" +
  @"<TableName>PFaaliyetAlanlari</TableName>" +
  @"<Version></Version>" +
  @"<Owner>SistemAyarlari</Owner>" +
  @"<TableCodeName>PFaaliyetAlanlari</TableCodeName>" +
  @"<TableAliasName>PFaaliyetAlanlari_</TableAliasName>" +
...
"</XMLDefinition>";
	...
	/// <see cref="PFaaliyetAlanlariTable"></see>
