...
/// <see cref="IhaleKategoriTable">KumePortali.IhaleKategoriTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="IhaleKategoriTable"></seealso>
public class IhaleKategoriDefinition
{
#region "Definition (XML) for IhaleKategoriDefinition table"
	//Next 90 lines contain Table Definition (XML) for table "IhaleKategoriDefinition"
	private static string _DefinitionString = 
@"<XMLDefinition Generator=""Iron Speed Designer"" Version=""5.2"" Type=""GENERIC"">" +
  @"<ColumnDefinition>" +
    @"<Column InternalName=""0"" Priority=""1"" ColumnNum=""0"">" +
      @"<columnName>IhaleKategoriID</columnName>" +
      @"<columnUIName>Ihale Kategori ID</columnUIName>" +
    ...
    @"<Column InternalName=""2"" Priority=""3"" ColumnNum=""2"">" +
      ...
      @"<columnTableAliasName></columnTableAliasName>" +
      @"<foreignKey>" +
        @"<columnFKName>FK_IhaleKategori_Ihale1</columnFKName>" +
    ...
    "</Column>" +
  "</ColumnDefinition>" +
  @"<TableName>IhaleKategori</TableName>" +
  @"<Version></Version>" +
  @"<Owner>ESatinAlma</Owner>" +
  @"<TableCodeName>IhaleKategori</TableCodeName>" +
  @"<TableAliasName>IhaleKategori_</TableAliasName>" +
...
"</XMLDefinition>";
	...
	/// <see cref="IhaleKategoriTable"></see>
