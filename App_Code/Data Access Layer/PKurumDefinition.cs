...
/// <see cref="PKurumTable">KumePortali.PKurumTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="PKurumTable"></seealso>
public class PKurumDefinition
{
#region "Definition (XML) for PKurumDefinition table"
	//Next 104 lines contain Table Definition (XML) for table "PKurumDefinition"
	private static string _DefinitionString = 
@"<XMLDefinition Generator=""Iron Speed Designer"" Version=""5.2"" Type=""GENERIC"">" +
  @"<ColumnDefinition>" +
    @"<Column InternalName=""0"" Priority=""1"" ColumnNum=""0"">" +
      @"<columnName>KurumID</columnName>" +
      @"<columnUIName>Kurum ID</columnUIName>" +
    ...
    @"<Column InternalName=""1"" Priority=""2"" ColumnNum=""1"">" +
      @"<columnName>KurumAdres</columnName>" +
      @"<columnUIName>Kurum Adres</columnUIName>" +
    ...
    @"<Column InternalName=""2"" Priority=""3"" ColumnNum=""2"">" +
      @"<columnName>KurumEnlem</columnName>" +
      @"<columnUIName>Kurum Enlem</columnUIName>" +
      @"<columnType>String</columnType>" +
    ...
    @"<Column InternalName=""3"" Priority=""4"" ColumnNum=""3"">" +
      @"<columnName>KurumBoylam</columnName>" +
      @"<columnUIName>Kurum Boylam</columnUIName>" +
      @"<columnType>String</columnType>" +
      @"<columnDBType>nchar</columnDBType>" +
      @"<columnLengthSet>50</columnLengthSet>" +
      @"<columnDefault></columnDefault>" +
    ...
    "</Column>" +
  "</ColumnDefinition>" +
  @"<TableName>PKurum</TableName>" +
  @"<Version></Version>" +
  @"<Owner>SistemAyarlari</Owner>" +
  @"<TableCodeName>PKurum</TableCodeName>" +
  @"<TableAliasName>PKurum_</TableAliasName>" +
