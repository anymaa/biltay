...
/// <see cref="PSertifikalarTable">KumePortali.PSertifikalarTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="PSertifikalarTable"></seealso>
public class PSertifikalarDefinition
{
#region "Definition (XML) for PSertifikalarDefinition table"
	//Next 82 lines contain Table Definition (XML) for table "PSertifikalarDefinition"
...
@"<XMLDefinition Generator=""Iron Speed Designer"" Version=""5.2"" Type=""GENERIC"">" +
  @"<ColumnDefinition>" +
    ...
    @"<Column InternalName=""1"" Priority=""2"" ColumnNum=""1"">" +
      @"<columnName>SertifikaAdi</columnName>" +
      @"<columnUIName>Sertifika Adi</columnUIName>" +
    ...
    "</Column>" +
  "</ColumnDefinition>" +
  @"<TableName>PSertifikalar</TableName>" +
  @"<Version></Version>" +
  @"<Owner>SistemAyarlari</Owner>" +
  @"<TableCodeName>PSertifikalar</TableCodeName>" +
  @"<TableAliasName>PSertifikalar_</TableAliasName>" +
...
"</XMLDefinition>";
	...
	/// <see cref="PSertifikalarTable"></see>
