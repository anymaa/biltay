...
/// <see cref="PFirmaYetenekleriTable">KumePortali.PFirmaYetenekleriTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="PFirmaYetenekleriTable"></seealso>
public class PFirmaYetenekleriDefinition
{
#region "Definition (XML) for PFirmaYetenekleriDefinition table"
	//Next 98 lines contain Table Definition (XML) for table "PFirmaYetenekleriDefinition"
	private static string _DefinitionString = 
@"<XMLDefinition Generator=""Iron Speed Designer"" Version=""5.2"" Type=""GENERIC"">" +
  @"<ColumnDefinition>" +
    @"<Column InternalName=""0"" Priority=""1"" ColumnNum=""0"">" +
      @"<columnName>FirmaYetenekID</columnName>" +
      @"<columnUIName>Firma Yetenek ID</columnUIName>" +
    ...
    @"<Column InternalName=""1"" Priority=""2"" ColumnNum=""1"">" +
      ...
      @"<columnTableAliasName></columnTableAliasName>" +
      @"<foreignKey>" +
        @"<columnFKName>FK_PFirmaYetenekleri_MIYSAHesaplar</columnFKName>" +
    ...
    @"<Column InternalName=""2"" Priority=""3"" ColumnNum=""2"">" +
      ...
      @"<columnTableAliasName></columnTableAliasName>" +
      @"<foreignKey>" +
        @"<columnFKName>FK_PFirmaYetenekleri_PYetenekler</columnFKName>" +
        @"<columnFKTable>KumePortali.Business.PYeteneklerTable, App_Code</columnFKTable>" +
        @"<columnFKOwner>SistemAyarlari</columnFKOwner>" +
        @"<columnFKColumn>YetenekID</columnFKColumn>" +
        @"<columnFKColumnDisplay>YeteneginAdi</columnFKColumnDisplay>" +
        @"<foreignKeyType>Explicit</foreignKeyType>" +
      "</foreignKey>" +
    "</Column>" +
  "</ColumnDefinition>" +
  @"<TableName>PFirmaYetenekleri</TableName>" +
  @"<Version></Version>" +
  @"<Owner>SistemAyarlari</Owner>" +
  @"<TableCodeName>PFirmaYetenekleri</TableCodeName>" +
  @"<TableAliasName>PFirmaYetenekleri_</TableAliasName>" +
...
"</XMLDefinition>";
	...
	/// <see cref="PFirmaYetenekleriTable"></see>
