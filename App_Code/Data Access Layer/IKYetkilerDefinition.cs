...
/// <see cref="IKYetkilerTable">KumePortali.IKYetkilerTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="IKYetkilerTable"></seealso>
public class IKYetkilerDefinition
{
#region "Definition (XML) for IKYetkilerDefinition table"
	//Next 82 lines contain Table Definition (XML) for table "IKYetkilerDefinition"
...
@"<XMLDefinition Generator=""Iron Speed Designer"" Version=""5.2"" Type=""GENERIC"">" +
  @"<ColumnDefinition>" +
    ...
    @"<Column InternalName=""1"" Priority=""2"" ColumnNum=""1"">" +
      @"<columnName>Yetki</columnName>" +
      @"<columnUIName>Yetki</columnUIName>" +
    ...
    @"<Column InternalName=""2"" Priority=""3"" ColumnNum=""2"">" +
      @"<columnName>YetkiAciklamasi</columnName>" +
      @"<columnUIName>Yetki Aciklamasi</columnUIName>" +
      @"<columnType>String</columnType>" +
      @"<columnDBType>nvarchar</columnDBType>" +
      @"<columnLengthSet>80</columnLengthSet>" +
      @"<columnDefault></columnDefault>" +
    ...
    "</Column>" +
  "</ColumnDefinition>" +
  @"<TableName>IKYetkiler</TableName>" +
  @"<Version></Version>" +
  @"<Owner>SistemAyarlari</Owner>" +
  @"<TableCodeName>IKYetkiler</TableCodeName>" +
  @"<TableAliasName>IKYetkiler_</TableAliasName>" +
