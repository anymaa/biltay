...
/// <see cref="PPersonelTipleriTable">KumePortali.PPersonelTipleriTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="PPersonelTipleriTable"></seealso>
public class PPersonelTipleriDefinition
{
#region "Definition (XML) for PPersonelTipleriDefinition table"
	//Next 82 lines contain Table Definition (XML) for table "PPersonelTipleriDefinition"
	private static string _DefinitionString = 
@"<XMLDefinition Generator=""Iron Speed Designer"" Version=""5.2"" Type=""GENERIC"">" +
  @"<ColumnDefinition>" +
    @"<Column InternalName=""0"" Priority=""1"" ColumnNum=""0"">" +
      @"<columnName>PersoneTipID</columnName>" +
      @"<columnUIName>Persone Tip ID</columnUIName>" +
    ...
    @"<Column InternalName=""1"" Priority=""2"" ColumnNum=""1"">" +
      @"<columnName>PersonelTipiAdi</columnName>" +
      @"<columnUIName>Personel Tipi Adi</columnUIName>" +
    ...
    "</Column>" +
  "</ColumnDefinition>" +
  @"<TableName>PPersonelTipleri</TableName>" +
  @"<Version></Version>" +
  @"<Owner>SistemAyarlari</Owner>" +
  @"<TableCodeName>PPersonelTipleri</TableCodeName>" +
  @"<TableAliasName>PPersonelTipleri_</TableAliasName>" +
...
"</XMLDefinition>";
	...
	/// <see cref="PPersonelTipleriTable"></see>
