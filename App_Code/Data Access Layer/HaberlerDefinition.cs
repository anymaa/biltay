...
/// <see cref="HaberlerTable">KumePortali.HaberlerTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="HaberlerTable"></seealso>
public class HaberlerDefinition
{
#region "Definition (XML) for HaberlerDefinition table"
	//Next 340 lines contain Table Definition (XML) for table "HaberlerDefinition"
	private static string _DefinitionString = 
@"<XMLDefinition Generator=""Iron Speed Designer"" Version=""5.2"" Type=""GENERIC"">" +
  @"<ColumnDefinition>" +
    @"<Column InternalName=""0"" Priority=""1"" ColumnNum=""0"">" +
      @"<columnName>HaberID</columnName>" +
      @"<columnUIName>Haber ID</columnUIName>" +
    ...
    @"<Column InternalName=""1"" Priority=""2"" ColumnNum=""1"">" +
      @"<columnName>HaberBaslik</columnName>" +
      @"<columnUIName>Haber Baslik</columnUIName>" +
    ...
    @"<Column InternalName=""2"" Priority=""3"" ColumnNum=""2"">" +
      @"<columnName>HaberBaslikEN</columnName>" +
      @"<columnUIName>Haber Baslik EN</columnUIName>" +
      @"<columnType>String</columnType>" +
      @"<columnDBType>nvarchar</columnDBType>" +
      @"<columnLengthSet>100</columnLengthSet>" +
      @"<columnDefault></columnDefault>" +
    ...
    @"<Column InternalName=""3"" Priority=""4"" ColumnNum=""3"">" +
      @"<columnName>HaberOnYazi</columnName>" +
      @"<columnUIName>Haber On Yazi</columnUIName>" +
      @"<columnType>String</columnType>" +
      @"<columnDBType>nvarchar</columnDBType>" +
    ...
    @"<Column InternalName=""4"" Priority=""5"" ColumnNum=""4"">" +
      @"<columnName>HaberOnYaziEN</columnName>" +
      @"<columnUIName>Haber On Yazi EN</columnUIName>" +
      @"<columnType>String</columnType>" +
      @"<columnDBType>nvarchar</columnDBType>" +
      @"<columnLengthSet>200</columnLengthSet>" +
      @"<columnDefault></columnDefault>" +
    ...
    @"<Column InternalName=""5"" Priority=""6"" ColumnNum=""5"">" +
      @"<columnName>HaberIcerik</columnName>" +
      @"<columnUIName>Haber Icerik</columnUIName>" +
    ...
    @"<Column InternalName=""6"" Priority=""7"" ColumnNum=""6"">" +
      @"<columnName>HaberIcerikEN</columnName>" +
      @"<columnUIName>Haber Icerik EN</columnUIName>" +
      @"<columnType>Very Large String</columnType>" +
      @"<columnDBType>ntext</columnDBType>" +
      @"<columnLengthSet>1073741823</columnLengthSet>" +
      @"<columnDefault></columnDefault>" +
    ...
    @"<Column InternalName=""7"" Priority=""8"" ColumnNum=""7"">" +
      @"<columnName>HaberAktif</columnName>" +
      @"<columnUIName>Haber Aktif</columnUIName>" +
    ...
    @"<Column InternalName=""10"" Priority=""11"" ColumnNum=""10"">" +
      ...
      @"<columnTableAliasName></columnTableAliasName>" +
      @"<foreignKey>" +
        @"<columnFKName>FK_Haberler_IKKullanicilar</columnFKName>" +
    ...
    @"<Column InternalName=""12"" Priority=""13"" ColumnNum=""12"">" +
      ...
      @"<columnTableAliasName></columnTableAliasName>" +
      @"<foreignKey>" +
        @"<columnFKName>FK_Haberler_IKKullanicilar1</columnFKName>" +
        @"<columnFKTable>KumePortali.Business.IKKullanicilarTable, App_Code</columnFKTable>" +
        @"<columnFKOwner>SistemAyarlari</columnFKOwner>" +
        @"<columnFKColumn>KullaniciID</columnFKColumn>" +
        @"<columnFKColumnDisplay>Adi</columnFKColumnDisplay>" +
    ...
    "</Column>" +
  "</ColumnDefinition>" +
  @"<TableName>Haberler</TableName>" +
  @"<Version></Version>" +
  @"<Owner>IcHaberlesme</Owner>" +
  @"<TableCodeName>Haberler</TableCodeName>" +
  @"<TableAliasName>Haberler_</TableAliasName>" +
