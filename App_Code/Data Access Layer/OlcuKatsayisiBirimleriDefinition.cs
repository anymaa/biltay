...
/// <see cref="OlcuKatsayisiBirimleriTable">KumePortali.OlcuKatsayisiBirimleriTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="OlcuKatsayisiBirimleriTable"></seealso>
public class OlcuKatsayisiBirimleriDefinition
{
#region "Definition (XML) for OlcuKatsayisiBirimleriDefinition table"
	//Next 148 lines contain Table Definition (XML) for table "OlcuKatsayisiBirimleriDefinition"
	private static string _DefinitionString = 
@"<XMLDefinition Generator=""Iron Speed Designer"" Version=""5.2"" Type=""GENERIC"">" +
  @"<ColumnDefinition>" +
    @"<Column InternalName=""0"" Priority=""1"" ColumnNum=""0"">" +
      @"<columnName>OlcuBirimID</columnName>" +
      @"<columnUIName>Olcu Birim ID</columnUIName>" +
    ...
    @"<Column InternalName=""1"" Priority=""2"" ColumnNum=""1"">" +
      @"<columnName>OlcuBirimAdi</columnName>" +
      @"<columnUIName>Olcu Birim Adi</columnUIName>" +
    ...
    @"<Column InternalName=""2"" Priority=""3"" ColumnNum=""2"">" +
      @"<columnName>OlcuBirimAdiEN</columnName>" +
      @"<columnUIName>Olcu Birim Adi EN</columnUIName>" +
      @"<columnType>String</columnType>" +
      @"<columnDBType>nvarchar</columnDBType>" +
      @"<columnLengthSet>50</columnLengthSet>" +
      @"<columnDefault></columnDefault>" +
    ...
    @"<Column InternalName=""3"" Priority=""4"" ColumnNum=""3"">" +
      @"<columnName>BirimTuru</columnName>" +
      @"<columnUIName>Birim Turu</columnUIName>" +
      @"<columnType>String</columnType>" +
      @"<columnDBType>nvarchar</columnDBType>" +
      @"<columnLengthSet>50</columnLengthSet>" +
      @"<columnDefault></columnDefault>" +
    ...
    "</Column>" +
  "</ColumnDefinition>" +
  @"<TableName>OlcuKatsayisiBirimleri</TableName>" +
  @"<Version></Version>" +
  @"<Owner>ESatinAlma</Owner>" +
  @"<TableCodeName>OlcuKatsayisiBirimleri</TableCodeName>" +
  @"<TableAliasName>OlcuKatsayisiBirimleri_</TableAliasName>" +
...
"</XMLDefinition>";
	...
	/// <see cref="OlcuKatsayisiBirimleriTable"></see>
