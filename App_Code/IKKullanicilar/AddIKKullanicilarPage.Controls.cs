...
// AddIKKullanicilarPage.aspx page.  The Row or RecordControl classes are the 
...
namespace KumePortali.UI.Controls.AddIKKullanicilarPage
{
...
// Base class for the HaberlerTableControlRow control on the AddIKKullanicilarPage page.
...
// Base class for the HaberlerTableControl control on the AddIKKullanicilarPage page.
...
#region "Helper Functions"
        ...
        public HaberlerTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (HaberlerTableControlRow[])(selectedList.ToArray(Type.GetType("KumePortali.UI.Controls.AddIKKullanicilarPage.HaberlerTableControlRow")));
        ...
        public HaberlerTableControlRow[] GetRecordControls()
        {
            ...
            return (HaberlerTableControlRow[])recList.ToArray(Type.GetType("KumePortali.UI.Controls.AddIKKullanicilarPage.HaberlerTableControlRow"));
        }
...
// Base class for the HaberlerTableControl1Row control on the AddIKKullanicilarPage page.
...
// Base class for the HaberlerTableControl1 control on the AddIKKullanicilarPage page.
...
#region "Helper Functions"
        ...
        public HaberlerTableControl1Row[] GetSelectedRecordControls()
        {
            ...
            return (HaberlerTableControl1Row[])(selectedList.ToArray(Type.GetType("KumePortali.UI.Controls.AddIKKullanicilarPage.HaberlerTableControl1Row")));
        ...
        public HaberlerTableControl1Row[] GetRecordControls()
        {
            ...
            return (HaberlerTableControl1Row[])recList.ToArray(Type.GetType("KumePortali.UI.Controls.AddIKKullanicilarPage.HaberlerTableControl1Row"));
        }
...
// Base class for the IKKullanicilarRecordControl control on the AddIKKullanicilarPage page.
...
public class BaseIKKullanicilarRecordControl : KumePortali.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (IKKullanicilarRecord)IKKullanicilarRecord.Copy(recList[0], false);
        ...
        public virtual void GetUIData()
        {
            ...
            foreach(BaseColumn col in IKKullanicilarRecord.TableUtils.TableDefinition.Columns){
...
#region "Helper Functions"
      ...
      if (rec == null && url.IndexOf("{") >= 0) {
        ...
        public IKKullanicilarRecord GetRecord()
        {
            ...
            return new IKKullanicilarRecord();
