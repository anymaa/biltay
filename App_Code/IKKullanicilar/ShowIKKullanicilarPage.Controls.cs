...
// ShowIKKullanicilarPage.aspx page.  The Row or RecordControl classes are the 
...
namespace KumePortali.UI.Controls.ShowIKKullanicilarPage
{
...
// Base class for the HaberlerTableControlRow control on the ShowIKKullanicilarPage page.
...
public class BaseHaberlerTableControlRow : KumePortali.UI.BaseApplicationRecordControl
{
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
            ...
            // Register the event handlers.
              ...
              this.DuzenleyenID1.Click += new EventHandler(DuzenleyenID1_Click);
        ...
        public override void DataBind()
        {
                ...
                if(formattedValue != null){
                    ...
                    if (formattedValue.Length >= popupThreshold) {
                         formattedValue = "<a OnClick=\'gPersist=true;\' OnMouseOut=\'detailRolloverPopupClose();\'" +
                            "OnMouseOver=\'SaveMousePosition(event); delayRolloverPopup(\"PageMethods.GetRecordFieldValue(\\\"KumePortali.Business.HaberlerTable, App_Code\\\",\\\"" +
                              (this.DataSource.GetID().ToString()).Replace("\\","\\\\\\\\") + "\\\", \\\"HaberBaslik\\\", \\\"Haber Baslik\\\"," +
                            " false, 200," +
            ...
            if (this.HaberBaslik.Text == null ||
                this.HaberBaslik.Text.Trim().Length == 0) {
                this.HaberBaslik.Text = "&nbsp;";
            }
            ...
            if (this.DataSource.HaberBaslikENSpecified) {
                ...
                if(formattedValue != null){
                    ...
                    if (formattedValue.Length >= popupThreshold) {
                         formattedValue = "<a OnClick=\'gPersist=true;\' OnMouseOut=\'detailRolloverPopupClose();\'" +
                            "OnMouseOver=\'SaveMousePosition(event); delayRolloverPopup(\"PageMethods.GetRecordFieldValue(\\\"KumePortali.Business.HaberlerTable, App_Code\\\",\\\"" +
                              (this.DataSource.GetID().ToString()).Replace("\\","\\\\\\\\") + "\\\", \\\"HaberBaslikEN\\\", \\\"Haber Baslik EN\\\"," +
                            " false, 200," +
                            " 300, true, PopupDisplayWindowCallBackWith20);\", 500);'>" + NetUtils.EncodeStringForHtmlDisplay(formattedValue.Substring(0, maxLength));
                        if (maxLength == (int)(100))
                            {
            ...
            if (this.HaberBaslikEN.Text == null ||
                this.HaberBaslikEN.Text.Trim().Length == 0) {
                this.HaberBaslikEN.Text = "&nbsp;";
            }
            ...
            if (this.DataSource.HaberOnYaziSpecified) {
                ...
                if(formattedValue != null){
                    ...
                    if (formattedValue.Length >= popupThreshold) {
                         formattedValue = "<a OnClick=\'gPersist=true;\' OnMouseOut=\'detailRolloverPopupClose();\'" +
                            "OnMouseOver=\'SaveMousePosition(event); delayRolloverPopup(\"PageMethods.GetRecordFieldValue(\\\"KumePortali.Business.HaberlerTable, App_Code\\\",\\\"" +
                              (this.DataSource.GetID().ToString()).Replace("\\","\\\\\\\\") + "\\\", \\\"HaberOnYazi\\\", \\\"Haber On Yazi\\\"," +
                            " false, 200," +
                            " 300, true, PopupDisplayWindowCallBackWith20);\", 500);'>" + NetUtils.EncodeStringForHtmlDisplay(formattedValue.Substring(0, maxLength));
                        if (maxLength == (int)(100))
                            {
            ...
            if (this.HaberOnYazi.Text == null ||
                this.HaberOnYazi.Text.Trim().Length == 0) {
                this.HaberOnYazi.Text = "&nbsp;";
            }
            ...
            if (this.DataSource.HaberOnYaziENSpecified) {
                ...
                if(formattedValue != null){
                    ...
                    if (formattedValue.Length >= popupThreshold) {
                         formattedValue = "<a OnClick=\'gPersist=true;\' OnMouseOut=\'detailRolloverPopupClose();\'" +
                            "OnMouseOver=\'SaveMousePosition(event); delayRolloverPopup(\"PageMethods.GetRecordFieldValue(\\\"KumePortali.Business.HaberlerTable, App_Code\\\",\\\"" +
                              (this.DataSource.GetID().ToString()).Replace("\\","\\\\\\\\") + "\\\", \\\"HaberOnYaziEN\\\", \\\"Haber On Yazi EN\\\"," +
                            " false, 200," +
                            " 300, true, PopupDisplayWindowCallBackWith20);\", 500);'>" + NetUtils.EncodeStringForHtmlDisplay(formattedValue.Substring(0, maxLength));
                        if (maxLength == (int)(100))
                            {
            ...
            if (this.HaberOnYaziEN.Text == null ||
                this.HaberOnYaziEN.Text.Trim().Length == 0) {
                this.HaberOnYaziEN.Text = "&nbsp;";
            }
            ...
            if (this.DataSource.HaberIcerikSpecified) {
                ...
                if(formattedValue != null){
                    ...
                    if (formattedValue.Length >= popupThreshold) {
                         formattedValue = "<a OnClick=\'gPersist=true;\' OnMouseOut=\'detailRolloverPopupClose();\'" +
                            "OnMouseOver=\'SaveMousePosition(event); delayRolloverPopup(\"PageMethods.GetRecordFieldValue(\\\"KumePortali.Business.HaberlerTable, App_Code\\\",\\\"" +
                              (this.DataSource.GetID().ToString()).Replace("\\","\\\\\\\\") + "\\\", \\\"HaberIcerik\\\", \\\"Haber Icerik\\\"," +
                            " false, 200," +
                            " 300, true, PopupDisplayWindowCallBackWith20);\", 500);'>" + NetUtils.EncodeStringForHtmlDisplay(formattedValue.Substring(0, maxLength));
                        if (maxLength == (int)(100))
                            {
                        ...
                        else
                        {
                            ...
                            formattedValue = "<table><tr><td>" + formattedValue + "</td></tr></table>";
                        }
                    }
                    else{
                        if (maxLength == (int)(100)) {
                ...
                this.HaberIcerik.Text = formattedValue;
              
               
            } else {  
                this.HaberIcerik.Text = HaberlerTable.HaberIcerik.Format(HaberlerTable.HaberIcerik.DefaultValue);
                            
            }
                    
            if (this.HaberIcerik.Text == null ||
                this.HaberIcerik.Text.Trim().Length == 0) {
                this.HaberIcerik.Text = "&nbsp;";
            }
            ...
            if (this.DataSource.HaberIcerikENSpecified) {
                ...
                if(formattedValue != null){
                    ...
                    if (formattedValue.Length >= popupThreshold) {
                         formattedValue = "<a OnClick=\'gPersist=true;\' OnMouseOut=\'detailRolloverPopupClose();\'" +
                            "OnMouseOver=\'SaveMousePosition(event); delayRolloverPopup(\"PageMethods.GetRecordFieldValue(\\\"KumePortali.Business.HaberlerTable, App_Code\\\",\\\"" +
                              (this.DataSource.GetID().ToString()).Replace("\\","\\\\\\\\") + "\\\", \\\"HaberIcerikEN\\\", \\\"Haber Icerik EN\\\"," +
                            " false, 200," +
                            " 300, true, PopupDisplayWindowCallBackWith20);\", 500);'>" + NetUtils.EncodeStringForHtmlDisplay(formattedValue.Substring(0, maxLength));
                        if (maxLength == (int)(100))
                            {
                ...
                this.HaberIcerikEN.Text = formattedValue;
              
               
            } else {  
                this.HaberIcerikEN.Text = HaberlerTable.HaberIcerikEN.Format(HaberlerTable.HaberIcerikEN.DefaultValue);
                            
            }
                    
            if (this.HaberIcerikEN.Text == null ||
                this.HaberIcerikEN.Text.Trim().Length == 0) {
                this.HaberIcerikEN.Text = "&nbsp;";
            }
                  
            if (this.DataSource.HaberAktifSpecified) {
                      
                string formattedValue = this.DataSource.Format(HaberlerTable.HaberAktif);
                formattedValue = HttpUtility.HtmlEncode(formattedValue);
                if(formattedValue != null){
                ...
                this.HaberAktif.Text = formattedValue;
              
               
            } else {  
                this.HaberAktif.Text = HaberlerTable.HaberAktif.Format(HaberlerTable.HaberAktif.DefaultValue);
                            
            }
                    
            if (this.HaberAktif.Text == null ||
                this.HaberAktif.Text.Trim().Length == 0) {
                this.HaberAktif.Text = "&nbsp;";
            }
            ...
            if (this.YetkiID.Text == null ||
                this.YetkiID.Text.Trim().Length == 0) {
                this.YetkiID.Text = "&nbsp;";
            }
            ...
            if (this.OlusturmaTarihi1.Text == null ||
                this.OlusturmaTarihi1.Text.Trim().Length == 0) {
                this.OlusturmaTarihi1.Text = "&nbsp;";
            }
            ...
            if (this.DuzenlenmeTarihi1.Text == null ||
                this.DuzenlenmeTarihi1.Text.Trim().Length == 0) {
                this.DuzenlenmeTarihi1.Text = "&nbsp;";
            }
                  
            if (this.DataSource.DuzenleyenIDSpecified) {
                      
                string formattedValue = this.DataSource.Format(HaberlerTable.DuzenleyenID);
                this.DuzenleyenID1.Text = formattedValue;
              
               
            } else {  
                this.DuzenleyenID1.Text = HaberlerTable.DuzenleyenID.Format(HaberlerTable.DuzenleyenID.DefaultValue);
                            
            }
                    
            if (this.DataSource.AktifPasifSpecified) {
                      
                string formattedValue = this.DataSource.Format(HaberlerTable.AktifPasif);
                formattedValue = HttpUtility.HtmlEncode(formattedValue);
                if(formattedValue != null){
                ...
                this.AktifPasif1.Text = formattedValue;
              
               
            } else {  
                this.AktifPasif1.Text = HaberlerTable.AktifPasif.Format(HaberlerTable.AktifPasif.DefaultValue);
                            
            }
                    
            if (this.AktifPasif1.Text == null ||
                this.AktifPasif1.Text.Trim().Length == 0) {
                this.AktifPasif1.Text = "&nbsp;";
            }
        ...
        public virtual void DuzenleyenID1_Click(object sender, EventArgs args)
        {
        
            string url = @"../IKKullanicilar/ShowIKKullanicilarPage.aspx?IKKullanicilar={HaberlerTableControlRow:FK:FK_Haberler_IKKullanicilar1}";
            bool shouldRedirect = true;
            string TargetKey;
			string tk = null;
			TargetKey = tk;
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Literal HaberBaslik {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "HaberBaslik");
            }
        }
            
        public System.Web.UI.WebControls.Literal HaberBaslikEN {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "HaberBaslikEN");
            }
        }
            
        public System.Web.UI.WebControls.Literal HaberOnYazi {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "HaberOnYazi");
            }
        }
            
        public System.Web.UI.WebControls.Literal HaberOnYaziEN {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "HaberOnYaziEN");
            }
        }
            
        public System.Web.UI.WebControls.Literal HaberIcerik {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "HaberIcerik");
            }
        }
            
        public System.Web.UI.WebControls.Literal HaberIcerikEN {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "HaberIcerikEN");
            }
        }
            
        public System.Web.UI.WebControls.Literal HaberAktif {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "HaberAktif");
            }
        }
            
        public System.Web.UI.WebControls.Literal YetkiID {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "YetkiID");
            }
        }
            
        public System.Web.UI.WebControls.Literal OlusturmaTarihi1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "OlusturmaTarihi1");
            }
        }
            
        public System.Web.UI.WebControls.Literal DuzenlenmeTarihi1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "DuzenlenmeTarihi1");
            }
        }
            
        public System.Web.UI.WebControls.LinkButton DuzenleyenID1 {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "DuzenleyenID1");
            }
        }
            
        public System.Web.UI.WebControls.Literal AktifPasif1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "AktifPasif1");
            }
        }
...
// Base class for the HaberlerTableControl control on the ShowIKKullanicilarPage page.
...
public class BaseHaberlerTableControl : KumePortali.UI.BaseApplicationTableControl
{
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
            ...
            // Setup the button events.
              ...
              this.HaberlerNewButton.Click += new ImageClickEventHandler(HaberlerNewButton_Click);
              this.HaberlerDeleteButton.Click += new ImageClickEventHandler(HaberlerDeleteButton_Click);
              this.HaberlerExportExcelButton.Click += new ImageClickEventHandler(HaberlerExportExcelButton_Click);
                      this.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(this,"HaberlerExportExcelButton"), MiscUtils.GetParentControlObject(this,"HaberlerTableControlUpdatePanel"));
    ...
    // Setup default pagination settings.
            ...
            if (!this.ResetData)
            {
                ...
                foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
                {
                    ...
                    if (recControl.Visible && recControl.IsNewRecord) {
                        ...
                        if (recControl.HaberIcerik.Text != "") {
                            rec.Parse(recControl.HaberIcerik.Text, HaberlerTable.HaberIcerik);
                  }
                
                        if (recControl.HaberIcerikEN.Text != "") {
                            rec.Parse(recControl.HaberIcerikEN.Text, HaberlerTable.HaberIcerikEN);
                  }
                
                        if (recControl.HaberAktif.Text != "") {
                            rec.Parse(recControl.HaberAktif.Text, HaberlerTable.HaberAktif);
                  }
                        ...
                        if (recControl.DuzenleyenID1.Text != "") {
                            rec.Parse(recControl.DuzenleyenID1.Text, HaberlerTable.DuzenleyenID);
                  }
                
                        if (recControl.AktifPasif1.Text != "") {
                            rec.Parse(recControl.AktifPasif1.Text, HaberlerTable.AktifPasif);
                  }
        ...
        // event handler for ImageButton
        public virtual void HaberlerNewButton_Click(object sender, ImageClickEventArgs args)
        {
        
            string url = @"../Haberler/AddHaberlerPage.aspx";
            bool shouldRedirect = true;
            string TargetKey;
			string tk = null;
			TargetKey = tk;
        ...
        // event handler for ImageButton
        public virtual void HaberlerExportExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            ExportData excelReport = new ExportData(HaberlerTable.Instance, wc, orderBy);
            // Add each of the columns in order of export.
            // To customize the data type, change the second parameter of the new ExcelColumn to be
            // a format string from Excel's Format Cell menu. For example "dddd, mmmm dd, yyyy h:mm AM/PM;@", "#,##0.00"
             excelReport.AddColumn(new ExcelColumn(HaberlerTable.HaberBaslik, @"Default"));
             excelReport.AddColumn(new ExcelColumn(HaberlerTable.HaberBaslikEN, @"Default"));
             excelReport.AddColumn(new ExcelColumn(HaberlerTable.HaberOnYazi, @"Default"));
             excelReport.AddColumn(new ExcelColumn(HaberlerTable.HaberOnYaziEN, @"Default"));
             excelReport.AddColumn(new ExcelColumn(HaberlerTable.HaberIcerik, @"Default"));
             excelReport.AddColumn(new ExcelColumn(HaberlerTable.HaberIcerikEN, @"Default"));
             excelReport.AddColumn(new ExcelColumn(HaberlerTable.HaberAktif, @"Default"));
             excelReport.AddColumn(new ExcelColumn(HaberlerTable.YetkiID, @"0"));
             excelReport.AddColumn(new ExcelColumn(HaberlerTable.OlusturmaTarihi, @"Short Date"));
             excelReport.AddColumn(new ExcelColumn(HaberlerTable.DuzenlenmeTarihi, @"Short Date"));
             excelReport.AddColumn(new ExcelColumn(HaberlerTable.DuzenleyenID, @"Default"));
             excelReport.AddColumn(new ExcelColumn(HaberlerTable.AktifPasif, @"Default"));
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton HaberlerNewButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "HaberlerNewButton");
            }
        }
        ...
        public System.Web.UI.WebControls.ImageButton HaberlerExportExcelButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "HaberlerExportExcelButton");
            }
        }
...
#region "Helper Functions"
        ...
        public HaberlerTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (HaberlerTableControlRow[])(selectedList.ToArray(Type.GetType("KumePortali.UI.Controls.ShowIKKullanicilarPage.HaberlerTableControlRow")));
        ...
        public HaberlerTableControlRow[] GetRecordControls()
        {
            ...
            return (HaberlerTableControlRow[])recList.ToArray(Type.GetType("KumePortali.UI.Controls.ShowIKKullanicilarPage.HaberlerTableControlRow"));
        }
...
// Base class for the HaberlerTableControl1Row control on the ShowIKKullanicilarPage page.
...
public class BaseHaberlerTableControl1Row : KumePortali.UI.BaseApplicationRecordControl
{
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
            ...
            // Register the event handlers.
              ...
              this.OlusturanID2.Click += new EventHandler(OlusturanID2_Click);
        ...
        public override void DataBind()
        {
            ...
            if (this.HaberBaslik1.Text == null ||
                this.HaberBaslik1.Text.Trim().Length == 0) {
                this.HaberBaslik1.Text = "&nbsp;";
            }
            ...
            if (this.HaberBaslikEN1.Text == null ||
                this.HaberBaslikEN1.Text.Trim().Length == 0) {
                this.HaberBaslikEN1.Text = "&nbsp;";
            }
            ...
            if (this.HaberOnYazi1.Text == null ||
                this.HaberOnYazi1.Text.Trim().Length == 0) {
                this.HaberOnYazi1.Text = "&nbsp;";
            }
            ...
            if (this.HaberOnYaziEN1.Text == null ||
                this.HaberOnYaziEN1.Text.Trim().Length == 0) {
                this.HaberOnYaziEN1.Text = "&nbsp;";
            }
            ...
            if (this.DataSource.HaberIcerikSpecified) {
                ...
                this.HaberIcerik1.Text = formattedValue;
              
               
            } else {  
                this.HaberIcerik1.Text = HaberlerTable.HaberIcerik.Format(HaberlerTable.HaberIcerik.DefaultValue);
                            
            }
                    
            if (this.HaberIcerik1.Text == null ||
                this.HaberIcerik1.Text.Trim().Length == 0) {
                this.HaberIcerik1.Text = "&nbsp;";
            }
            ...
            if (this.DataSource.HaberIcerikENSpecified) {
                ...
                this.HaberIcerikEN1.Text = formattedValue;
              
               
            } else {  
                this.HaberIcerikEN1.Text = HaberlerTable.HaberIcerikEN.Format(HaberlerTable.HaberIcerikEN.DefaultValue);
                            
            }
                    
            if (this.HaberIcerikEN1.Text == null ||
                this.HaberIcerikEN1.Text.Trim().Length == 0) {
                this.HaberIcerikEN1.Text = "&nbsp;";
            }
            ...
            if (this.DataSource.HaberAktifSpecified) {
                ...
                this.HaberAktif1.Text = formattedValue;
              
               
            } else {  
                this.HaberAktif1.Text = HaberlerTable.HaberAktif.Format(HaberlerTable.HaberAktif.DefaultValue);
                            
            }
                    
            if (this.HaberAktif1.Text == null ||
                this.HaberAktif1.Text.Trim().Length == 0) {
                this.HaberAktif1.Text = "&nbsp;";
            }
            ...
            if (this.YetkiID1.Text == null ||
                this.YetkiID1.Text.Trim().Length == 0) {
                this.YetkiID1.Text = "&nbsp;";
            }
            ...
            if (this.OlusturmaTarihi2.Text == null ||
                this.OlusturmaTarihi2.Text.Trim().Length == 0) {
                this.OlusturmaTarihi2.Text = "&nbsp;";
            }
                  
            if (this.DataSource.OlusturanIDSpecified) {
                      
                string formattedValue = this.DataSource.Format(HaberlerTable.OlusturanID);
                this.OlusturanID2.Text = formattedValue;
              
               
            } else {  
                this.OlusturanID2.Text = HaberlerTable.OlusturanID.Format(HaberlerTable.OlusturanID.DefaultValue);
            ...
            if (this.DuzenlenmeTarihi2.Text == null ||
                this.DuzenlenmeTarihi2.Text.Trim().Length == 0) {
                this.DuzenlenmeTarihi2.Text = "&nbsp;";
            }
            ...
            if (this.DataSource.AktifPasifSpecified) {
                ...
                this.AktifPasif2.Text = formattedValue;
              
               
            } else {  
                this.AktifPasif2.Text = HaberlerTable.AktifPasif.Format(HaberlerTable.AktifPasif.DefaultValue);
                            
            }
                    
            if (this.AktifPasif2.Text == null ||
                this.AktifPasif2.Text.Trim().Length == 0) {
                this.AktifPasif2.Text = "&nbsp;";
            }
        ...
        // event handler for LinkButton
        public virtual void OlusturanID2_Click(object sender, EventArgs args)
        {
        
            string url = @"../IKKullanicilar/ShowIKKullanicilarPage.aspx?IKKullanicilar={HaberlerTableControl1Row:FK:FK_Haberler_IKKullanicilar}";
            bool shouldRedirect = true;
            string TargetKey;
			string tk = null;
			TargetKey = tk;
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Literal HaberBaslik1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "HaberBaslik1");
            }
        }
            
        public System.Web.UI.WebControls.Literal HaberBaslikEN1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "HaberBaslikEN1");
            }
        }
            
        public System.Web.UI.WebControls.Literal HaberOnYazi1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "HaberOnYazi1");
            }
        }
            
        public System.Web.UI.WebControls.Literal HaberOnYaziEN1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "HaberOnYaziEN1");
            }
        }
            
        public System.Web.UI.WebControls.Literal HaberIcerik1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "HaberIcerik1");
            }
        }
            
        public System.Web.UI.WebControls.Literal HaberIcerikEN1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "HaberIcerikEN1");
            }
        }
            
        public System.Web.UI.WebControls.Literal HaberAktif1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "HaberAktif1");
            }
        }
            
        public System.Web.UI.WebControls.Literal YetkiID1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "YetkiID1");
            }
        }
            
        public System.Web.UI.WebControls.Literal OlusturmaTarihi2 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "OlusturmaTarihi2");
            }
        }
            
        public System.Web.UI.WebControls.LinkButton OlusturanID2 {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "OlusturanID2");
            }
        }
            
        public System.Web.UI.WebControls.Literal DuzenlenmeTarihi2 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "DuzenlenmeTarihi2");
            }
        }
            
        public System.Web.UI.WebControls.Literal AktifPasif2 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "AktifPasif2");
            }
        }
...
// Base class for the HaberlerTableControl1 control on the ShowIKKullanicilarPage page.
...
public class BaseHaberlerTableControl1 : KumePortali.UI.BaseApplicationTableControl
{
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
            ...
            // Setup the button events.
              ...
              this.HaberlerNewButton1.Click += new ImageClickEventHandler(HaberlerNewButton1_Click);
              this.HaberlerDeleteButton1.Click += new ImageClickEventHandler(HaberlerDeleteButton1_Click);
              this.HaberlerExportExcelButton1.Click += new ImageClickEventHandler(HaberlerExportExcelButton1_Click);
                      this.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(this,"HaberlerExportExcelButton1"), MiscUtils.GetParentControlObject(this,"HaberlerTableControl1UpdatePanel"));
    ...
    // Setup default pagination settings.
            ...
            if (!this.ResetData)
            {
                ...
                foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
                {
                    ...
                    if (recControl.Visible && recControl.IsNewRecord) {
                        ...
                        if (recControl.HaberIcerik1.Text != "") {
                            rec.Parse(recControl.HaberIcerik1.Text, HaberlerTable.HaberIcerik);
                  }
                
                        if (recControl.HaberIcerikEN1.Text != "") {
                            rec.Parse(recControl.HaberIcerikEN1.Text, HaberlerTable.HaberIcerikEN);
                  }
                
                        if (recControl.HaberAktif1.Text != "") {
                            rec.Parse(recControl.HaberAktif1.Text, HaberlerTable.HaberAktif);
                  }
                        ...
                        if (recControl.OlusturanID2.Text != "") {
                            rec.Parse(recControl.OlusturanID2.Text, HaberlerTable.OlusturanID);
                  }
                        ...
                        if (recControl.AktifPasif2.Text != "") {
                            rec.Parse(recControl.AktifPasif2.Text, HaberlerTable.AktifPasif);
                  }
        ...
        // event handler for ImageButton
        public virtual void HaberlerNewButton1_Click(object sender, ImageClickEventArgs args)
        {
        ...
        // event handler for ImageButton
        public virtual void HaberlerExportExcelButton1_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // a format string from Excel's Format Cell menu. For example "dddd, mmmm dd, yyyy h:mm AM/PM;@", "#,##0.00"
             ...
             excelReport.AddColumn(new ExcelColumn(HaberlerTable.YetkiID, @"0"));
             excelReport.AddColumn(new ExcelColumn(HaberlerTable.OlusturmaTarihi, @"Short Date"));
             excelReport.AddColumn(new ExcelColumn(HaberlerTable.OlusturanID, @"Default"));
             excelReport.AddColumn(new ExcelColumn(HaberlerTable.DuzenlenmeTarihi, @"Short Date"));
             excelReport.AddColumn(new ExcelColumn(HaberlerTable.AktifPasif, @"Default"));
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton HaberlerNewButton1 {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "HaberlerNewButton1");
            }
        }
        ...
        public System.Web.UI.WebControls.ImageButton HaberlerExportExcelButton1 {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "HaberlerExportExcelButton1");
            }
        }
...
#region "Helper Functions"
        ...
        public HaberlerTableControl1Row[] GetSelectedRecordControls()
        {
            ...
            return (HaberlerTableControl1Row[])(selectedList.ToArray(Type.GetType("KumePortali.UI.Controls.ShowIKKullanicilarPage.HaberlerTableControl1Row")));
        ...
        public HaberlerTableControl1Row[] GetRecordControls()
        {
            ...
            return (HaberlerTableControl1Row[])recList.ToArray(Type.GetType("KumePortali.UI.Controls.ShowIKKullanicilarPage.HaberlerTableControl1Row"));
        }
...
// Base class for the IKKullanicilarRecordControl control on the ShowIKKullanicilarPage page.
...
public class BaseIKKullanicilarRecordControl : KumePortali.UI.BaseApplicationRecordControl
{
        ...
        public virtual void FirmaID_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../MIYSAHesaplar/ShowMIYSAHesaplarPage.aspx?MIYSAHesaplar={IKKullanicilarRecordControl:FK:FK_IKKullanicilar_Firma}";
            bool shouldRedirect = true;
            string TargetKey;
			string tk = null;
			TargetKey = tk;
        ...
        public virtual void UnvanID_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../IKUnvanlar/ShowIKUnvanlarPage.aspx?IKUnvanlar={IKKullanicilarRecordControl:FK:FK_IKKullanicilar_IKUnvanlar}";
            bool shouldRedirect = true;
            string TargetKey;
			string tk = null;
			TargetKey = tk;
        ...
        public virtual void OlusturanID_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../IKKullanicilar/ShowIKKullanicilarPage.aspx?IKKullanicilar={IKKullanicilarRecordControl:FK:FK_IKKullanicilar_IKKullanicilar}";
            bool shouldRedirect = true;
            string TargetKey;
			string tk = null;
			TargetKey = tk;
        ...
        public virtual void DuzenleyenID_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../IKKullanicilar/ShowIKKullanicilarPage.aspx?IKKullanicilar={IKKullanicilarRecordControl:FK:FK_IKKullanicilar_IKKullanicilar1}";
            bool shouldRedirect = true;
            string TargetKey;
			string tk = null;
			TargetKey = tk;
