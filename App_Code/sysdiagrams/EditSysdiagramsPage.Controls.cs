...
// EditSysdiagramsPage.aspx page.  The Row or RecordControl classes are the 
...
namespace KumePortali.UI.Controls.EditSysdiagramsPage
{
...
// Base class for the SysdiagramsRecordControl control on the EditSysdiagramsPage page.
...
public class BaseSysdiagramsRecordControl : KumePortali.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = SysdiagramsTable.GetRecord(recList[0].GetID().ToXmlString(), true);
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (recId == null || recId.Length == 0) {
                ...
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "KumePortali").Replace("{URL}", "Sysdiagrams"));
            }
