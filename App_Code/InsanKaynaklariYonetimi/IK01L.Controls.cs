...
// IK01L.aspx page.  The Row or RecordControl classes are the 
...
namespace KumePortali.UI.Controls.IK01L
{
...
// Base class for the IKKullanicilarTableControlRow control on the IK01L page.
...
public class BaseIKKullanicilarTableControlRow : KumePortali.UI.BaseApplicationRecordControl
{
        ...
        public override void DataBind()
        {
            ...
            if (this.FirmaID.Text == null ||
                this.FirmaID.Text.Trim().Length == 0) {
                this.FirmaID.Text = "&nbsp;";
            }
            ...
            if (this.OlusturanID.Text == null ||
                this.OlusturanID.Text.Trim().Length == 0) {
                this.OlusturanID.Text = "&nbsp;";
            }
            ...
            if (this.UnvanID.Text == null ||
                this.UnvanID.Text.Trim().Length == 0) {
                this.UnvanID.Text = "&nbsp;";
            }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Literal FirmaID {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "FirmaID");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal OlusturanID {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "OlusturanID");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal UnvanID {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "UnvanID");
            }
        }
...
// Base class for the IKKullanicilarTableControl control on the IK01L page.
...
public class BaseIKKullanicilarTableControl : KumePortali.UI.BaseApplicationTableControl
{
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
            ...
            // Setup the sorting events.
              ...
              this.FirmaIDLabel.Click += new EventHandler(FirmaIDLabel_Click);
              ...
              this.UnvanIDLabel.Click += new EventHandler(UnvanIDLabel_Click);
    ...
    // Setup default pagination settings.
        ...
        // event handler for FieldSort
        public virtual void FirmaIDLabel_Click(object sender, EventArgs args)
        {
        ...
        // event handler for FieldSort
        public virtual void UnvanIDLabel_Click(object sender, EventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.LinkButton FirmaIDLabel {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "FirmaIDLabel");
            }
        }
        
        public System.Web.UI.WebControls.Literal FirmaIDLabel1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "FirmaIDLabel1");
            }
        }
        ...
        public System.Web.UI.WebControls.LinkButton UnvanIDLabel {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "UnvanIDLabel");
            }
        }
        
        public System.Web.UI.WebControls.Literal UnvanIDLabel1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "UnvanIDLabel1");
            }
        }
...
#region "Helper Functions"
        ...
        public IKKullanicilarTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (IKKullanicilarTableControlRow[])(selectedList.ToArray(Type.GetType("KumePortali.UI.Controls.IK01L.IKKullanicilarTableControlRow")));
        ...
        public IKKullanicilarTableControlRow[] GetRecordControls()
        {
            ...
            return (IKKullanicilarTableControlRow[])recList.ToArray(Type.GetType("KumePortali.UI.Controls.IK01L.IKKullanicilarTableControlRow"));
        }
