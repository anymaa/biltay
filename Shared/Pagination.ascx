...
<%@ Control Language="C#" AutoEventWireup="false" CodeFile="Pagination.ascx.cs" Inherits="KumePortali.UI.Pagination" %>
...
<table cellspacing="0" cellpadding="0" border="0">
 <tr>
	...
	<td><img src="../Images/ButtonBarDivider.gif"></td>
	<td class="prbg"><b><%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControl("_PageSizeButton")) %><asp:TextBox runat="server" id="_CurrentPage" CssClass="Pagination_Input" MaxLength="5" Size="3" onkeyup="adjustPageSize(this, event.keyCode, 1, 999);">
...
</asp:Label></b>&nbsp;<%# GetResourceValue("Txt:Items", "KumePortali") %></td>
	<td><img src="../Images/ButtonBarDivider.gif"></td>
	<td class="prbg"><%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControl("_PageSizeButton")) %><asp:TextBox runat="server" id="_PageSize" CssClass="Pagination_Input" MaxLength="5" Size="3" onkeyup="adjustPageSize(this, event.keyCode, 1, 999);">
...
<%= SystemUtils.GenerateIncrementDecrementButtons(true, FindControl("_PageSize"),"PaginationTextBox2","","","") %>
	...
	<td class="prbg">/<%# GetResourceValue("Txt:Page", "KumePortali") %></td>
	<td><img src="../Images/ButtonBarDivider.gif"></td>
