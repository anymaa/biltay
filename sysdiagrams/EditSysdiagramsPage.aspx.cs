...
// This file implements the code-behind class for EditSysdiagramsPage.aspx.
// App_Code\EditSysdiagramsPage.Controls.vb contains the Table, Row and Record control classes
...
partial class EditSysdiagramsPage
        : BaseApplicationPage
// Code-behind class for the EditSysdiagramsPage page.
...
#region "Section 2: Do not modify this section."
      ...
      // their parent ids from their parent UI controls.
                    ...
                    this.SysdiagramsRecordControl.LoadData();
        ...
        public void SaveButton_Click_Base(object sender, EventArgs args)
        {
            ...
            try {
                ...
                if (!this.IsPageRefresh) {
                    ...
                    this.SysdiagramsRecordControl.SaveData();
            ...
            if(TargetKey != null){
				...
				if (this.SysdiagramsRecordControl != null && this.SysdiagramsRecordControl.DataSource != null){
					id = this.SysdiagramsRecordControl.DataSource.diagram_id.ToString();
					value = this.SysdiagramsRecordControl.DataSource.GetValue(this.SysdiagramsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString();
					if(value == null){
					  value = id;
					}
