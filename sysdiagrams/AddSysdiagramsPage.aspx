<%@ Register Tagprefix="KumePortali" Namespace="KumePortali.UI.Controls.AddSysdiagramsPage" %>

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="AddSysdiagramsPage.aspx.cs" Culture="tr-TR" Inherits="KumePortali.UI.AddSysdiagramsPage" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <title><asp:Literal runat="server" id="PageTitle" Text="&lt;%#String.Concat(GetResourceValue(&quot;Title:Add&quot;, &quot;KumePortali&quot;),&quot; Sysdiagrams&quot;) %>">
</asp:Literal></title>
...
<!-- Begin Record Panel.html -->
 ...
 <%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControl("EditButton$_Button")) %>
    ...
    <tr>
    <td class="dhtr" valign="middle"><asp:Literal runat="server" id="SysdiagramsTitle" Text="Add Sysdiagrams">
														</asp:Literal></td>
    </tr>
    </table>
    </td>
