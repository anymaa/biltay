<%@ Register Tagprefix="KumePortali" Namespace="KumePortali.UI.Controls.IK01L" %>
...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="IK01L.aspx.cs" Culture="tr-TR" Inherits="KumePortali.UI.IK01L" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <form id="Form1" method="post" runat="server"><BaseClasses:ScrollCoordinates id="ScrollCoordinates" runat="server"></BaseClasses:ScrollCoordinates>
        ...
        <table cellspacing="0" cellpadding="0" border="0" class="pbTable">
            ...
            <tr>
                <td class="pcL">
                    <KumePortali:Menu runat="server" id="MenuV" HiliteSettings="
          ">
		</KumePortali:Menu></td>
                <td class="pcC">
...
<asp:UpdateProgress runat="server" id="IKKullanicilarTableControlUpdateProgress" AssociatedUpdatePanelID="IKKullanicilarTableControlUpdatePanel">
    ...
    <tr>
    <td class="dhel"><img src="../Images/space.gif" alt=""/></td><td class="dht" valign="middle"><asp:Literal runat="server" id="IKKullanicilarTitle" Text="KULLANICI LİSTESİ">
														</asp:Literal></td>
    <td class="dhtrc">
    ...
    <td class="dher"><img src="../Images/space.gif" alt=""/></td>
        ...
        <table id="FilterRegion" cellpadding="0" cellspacing="3" border="0">
            ...
            <%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControl("IKKullanicilarTableControl$IKKullanicilarFilterButton")) %>
                <tr>
                <td class="fila"><asp:Literal runat="server" id="FirmaIDLabel1" Text="Firma Adı">
                ...
                <tr>
                <td class="fila"><asp:Literal runat="server" id="UnvanIDLabel1" Text="Unvanı">
        ...
        <td>
            ...
            <th class="thc" scope="col"><asp:LinkButton runat="server" id="FirmaIDLabel" Text="Firma Adı" CausesValidation="False">
															</asp:LinkButton>
            </th>
            <th class="thc" scope="col"><asp:LinkButton runat="server" id="UnvanIDLabel" Text="Unvanı" CausesValidation="False">
															</asp:LinkButton>
            </th>
            ...
            <td class="ttc" ><asp:Literal runat="server" id="FirmaID">
																				</asp:Literal></td>
            <td class="ttc" ><asp:Literal runat="server" id="UnvanID">
																				</asp:Literal></td>
            ...
            <td class="ttc" ><asp:Literal runat="server" id="OlusturanID">
																				</asp:Literal></td>
            </tr>
            </div>
